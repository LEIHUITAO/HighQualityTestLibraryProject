  ...
  33                     ; 52 void ADC1_DeInit(void)
  33                     ; 53 {
  35                     .text:	section	.text,new
  36  0000               _ADC1_DeInit:
  40                     ; 54   ADC1->CSR  = ADC1_CSR_RESET_VALUE;
  42  0000 725f5400      	clr	21504
  43                     ; 55   ADC1->CR1  = ADC1_CR1_RESET_VALUE;
  45  0004 725f5401      	clr	21505
  46                     ; 56   ADC1->CR2  = ADC1_CR2_RESET_VALUE;
  48  0008 725f5402      	clr	21506
  49                     ; 57   ADC1->CR3  = ADC1_CR3_RESET_VALUE;
  51  000c 725f5403      	clr	21507
  52                     ; 58   ADC1->TDRH = ADC1_TDRH_RESET_VALUE;
  54  0010 725f5406      	clr	21510
  55                     ; 59   ADC1->TDRL = ADC1_TDRL_RESET_VALUE;
  57  0014 725f5407      	clr	21511
  58                     ; 60   ADC1->HTRH = ADC1_HTRH_RESET_VALUE;
  60  0018 35ff5408      	mov	21512,#255
  61                     ; 61   ADC1->HTRL = ADC1_HTRL_RESET_VALUE;
  63  001c 35035409      	mov	21513,#3
  64                     ; 62   ADC1->LTRH = ADC1_LTRH_RESET_VALUE;
  66  0020 725f540a      	clr	21514
  67                     ; 63   ADC1->LTRL = ADC1_LTRL_RESET_VALUE;
  69  0024 725f540b      	clr	21515
  70                     ; 64   ADC1->AWCRH = ADC1_AWCRH_RESET_VALUE;
  72  0028 725f540e      	clr	21518
  73                     ; 65   ADC1->AWCRL = ADC1_AWCRL_RESET_VALUE;
  75  002c 725f540f      	clr	21519
  76                     ; 66 }
  79  0030 81            	ret	
 531                     ; 88 void ADC1_Init(ADC1_ConvMode_TypeDef ADC1_ConversionMode, ADC1_Channel_TypeDef ADC1_Channel, ADC1_PresSel_TypeDef ADC1_PrescalerSelection, ADC1_ExtTrig_TypeDef ADC1_ExtTrigger, FunctionalState ADC1_ExtTriggerState, ADC1_Align_TypeDef ADC1_Align, ADC1_SchmittTrigg_TypeDef ADC1_SchmittTriggerChannel, FunctionalState ADC1_SchmittTriggerState)
 531                     ; 89 {
 532                     .text:	section	.text,new
 533  0000               _ADC1_Init:
 535  0000 89            	pushw	x
 536       00000000      OFST:	set	0
 539                     ; 91   assert_param(IS_ADC1_CONVERSIONMODE_OK(ADC1_ConversionMode));
 541  0001 9e            	ld	a,xh
 542  0002 4d            	tnz	a
 ...
 574  003b ae005c        	ldw	x,#92
 575  003e cd00f9        	call	LC001
 576  0041               L42:
 577                     ; 93   assert_param(IS_ADC1_PRESSEL_OK(ADC1_PrescalerSelection));
 ...
 651  00be ae0061        	ldw	x,#97
 652  00c1 ad36          	call	LC001
 653  00c3               L47:
 654                     ; 98   assert_param(IS_FUNCTIONALSTATE_OK(ADC1_SchmittTriggerState));
 656  00c3 7b0a          	ld	a,(OFST+10,sp)
 657  00c5 2708          	jreq	L401
 658  00c7 4a            	dec	a
 659  00c8 2705          	jreq	L401
 660  00ca ae0062        	ldw	x,#98
 661  00cd ad2a          	call	LC001
 662  00cf               L401:
 663                     ; 103   ADC1_ConversionConfig(ADC1_ConversionMode, ADC1_Channel, ADC1_Align);
 ...
 755                     ; 129   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 757  0001 4d            	tnz	a
 758  0002 2711          	jreq	L621
 759  0004 4a            	dec	a
 760  0005 270e          	jreq	L621
 761  0007 ae0081        	ldw	x,#129
 762  000a 89            	pushw	x
 763  000b 5f            	clrw	x
 764  000c 89            	pushw	x
...
1157  003d 81            	ret	
1193                     ; 214 void ADC1_PrescalerConfig(ADC1_PresSel_TypeDef ADC1_Prescaler)
1193                     ; 215 {
1194                     .text:	section	.text,new
1195  0000               _ADC1_PrescalerConfig:
1197  0000 88            	push	a
1198       00000000      OFST:	set	0
1201                     ; 217   assert_param(IS_ADC1_PRESSEL_OK(ADC1_Prescaler));
1203  0001 4d            	tnz	a
...
1227  002e               L602:
1228                     ; 220   ADC1->CR1 &= (uint8_t)(~ADC1_CR1_SPSEL);
1230  002e c65401        	ld	a,21505
1231  0031 a48f          	and	a,#143
1232  0033 c75401        	ld	21505,a
1233                     ; 222   ADC1->CR1 |= (uint8_t)(ADC1_Prescaler);
...
1241  003e 84            	pop	a
1242  003f 81            	ret	
1290                     ; 233 void ADC1_SchmittTriggerConfig(ADC1_SchmittTrigg_TypeDef ADC1_SchmittTriggerChannel, FunctionalState NewState)
1290                     ; 234 {
1291                     .text:	section	.text,new
1292  0000               _ADC1_SchmittTriggerConfig:
1294  0000 89            	pushw	x
1295       00000000      OFST:	set	0
1298                     ; 236   assert_param(IS_ADC1_SCHMITTTRIG_OK(ADC1_SchmittTriggerChannel));
...
1400  0088               L774:
1401                     ; 260       ADC1->TDRL |= (uint8_t)((uint8_t)0x01 << (uint8_t)ADC1_SchmittTriggerChannel);
...
1412  0095               L574:
1413                     ; 265     if (NewState != DISABLE)
1415  0095 2710          	jreq	L505
1416                     ; 267       ADC1->TDRH &= (uint8_t)(~(uint8_t)((uint8_t)0x01 << ((uint8_t)ADC1_SchmittTriggerChannel - (uint8_t)8)));
...
1430  00a7               L505:
1431                     ; 271       ADC1->TDRH |= (uint8_t)((uint8_t)0x01 << ((uint8_t)ADC1_SchmittTriggerChannel - (uint8_t)8));
...
1465  00ca 81            	ret	
1522                     ; 286 void ADC1_ConversionConfig(ADC1_ConvMode_TypeDef ADC1_ConversionMode, ADC1_Channel_TypeDef ADC1_Channel, ADC1_Align_TypeDef ADC1_Align)
1522                     ; 287 {
1523                     .text:	section	.text,new
1524  0000               _ADC1_ConversionConfig:
1526  0000 89            	pushw	x
1527       00000000      OFST:	set	0
1530                     ; 289   assert_param(IS_ADC1_CONVERSIONMODE_OK(ADC1_ConversionMode));
...
1538  0009 ae0121        	ldw	x,#289
1539  000c ad6b          	call	LC007
1540  000e               L262:
1541                     ; 290   assert_param(IS_ADC1_CHANNEL_OK(ADC1_Channel));
...
1624  0084 81            	ret	
1670                     ; 325 void ADC1_ExternalTriggerConfig(ADC1_ExtTrig_TypeDef ADC1_ExtTrigger, FunctionalState NewState)
1670                     ; 326 {
1671                     .text:	section	.text,new
1672  0000               _ADC1_ExternalTriggerConfig:
1674  0000 89            	pushw	x
1675       00000000      OFST:	set	0
1678                     ; 328   assert_param(IS_ADC1_EXTTRIG_OK(ADC1_ExtTrigger));
...
1863  002f               L126:
1864                     ; 394   return ((uint16_t)temph);
1868  002f 5b05          	addw	sp,#5
1869  0031 81            	ret	
1916                     ; 405 void ADC1_AWDChannelConfig(ADC1_Channel_TypeDef Channel, FunctionalState NewState)
1916                     ; 406 {
1917                     .text:	section	.text,new
1918  0000               _ADC1_AWDChannelConfig:
1920  0000 89            	pushw	x
1921       00000000      OFST:	set	0
1924                     ; 408   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
1932  0009 ae0198        	ldw	x,#408
1933  000c cd0092        	call	LC012
1934  000f               L243:
1935                     ; 409   assert_param(IS_ADC1_CHANNEL_OK(Channel));
...
1983  0057               L746:
1984                     ; 419       ADC1->AWCRL &= (uint8_t)~(uint8_t)((uint8_t)1 << Channel);
...
1998  0068               L546:
1999                     ; 424     if (NewState != DISABLE)
2001  0068 270f          	jreq	L556
2002                     ; 426       ADC1->AWCRH |= (uint8_t)((uint8_t)1 << (Channel - (uint8_t)8));
...
2015  0079               L556:
2016                     ; 430       ADC1->AWCRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (uint8_t)(Channel - (uint8_t)8));
...
2154                     ; 457 }
2157  000a 81            	ret	
2205                     ; 466 uint16_t ADC1_GetBufferValue(uint8_t Buffer)
2205                     ; 467 {
...
2214                     ; 468   uint16_t temph = 0;
2216                     ; 469   uint8_t templ = 0;
2218                     ; 472   assert_param(IS_ADC1_BUFFER_OK(Buffer));
2220  0003 7b06          	ld	a,(OFST+1,sp)
2221  0005 a10a          	cp	a,#10
2222  0007 2510          	jrult	L604
2223  0009 ae01d8        	ldw	x,#472
...
2232  0019               L604:
2233                     ; 474   if ((ADC1->CR2 & ADC1_CR2_ALIGN) != 0) /* Right alignment */
2235  0019 48            	sll	a
2236  001a 5f            	clrw	x
2237  001b 97            	ld	xl,a
2238  001c 7207540213    	btjf	21506,#3,L137
2239                     ; 477     templ = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1) + 1);
2241  0021 d653e1        	ld	a,(21473,x)
2242  0024 6b03          	ld	(OFST-2,sp),a
2243                     ; 479     temph = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1));
...
2251                     ; 481     temph = (uint16_t)(templ | (uint16_t)(temph << (uint8_t)8));
2253  002f 7b03          	ld	a,(OFST-2,sp)
2254  0031 02            	rlwa	x,a
2256  0032 2024          	jra	L337
2257  0034               L137:
2258                     ; 486     temph = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1));
2260  0034 d653e0        	ld	a,(21472,x)
2261  0037 5f            	clrw	x
2262  0038 97            	ld	xl,a
2263  0039 1f04          	ldw	(OFST-1,sp),x
2264                     ; 488     templ = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1) + 1);
...
2272                     ; 490     temph = (uint16_t)((uint16_t)((uint16_t)templ << 6) | (uint16_t)(temph << 8));
...
2287  0058               L337:
2288                     ; 493   return ((uint16_t)temph);
2292  0058 5b06          	addw	sp,#6
2293  005a 81            	ret	
2358                     ; 502 FlagStatus ADC1_GetAWDChannelStatus(ADC1_Channel_TypeDef Channel)
2358                     ; 503 {
...
2367                     ; 504   uint8_t status = 0;
2369  0002 0f01          	clr	(OFST+0,sp)
2370                     ; 507   assert_param(IS_ADC1_CHANNEL_OK(Channel));
2372  0004 4d            	tnz	a
...
2402  003d               L024:
2403                     ; 509   if (Channel < (uint8_t)8)
2405  003d 7b02          	ld	a,(OFST+1,sp)
2406  003f a108          	cp	a,#8
2407  0041 2410          	jruge	L567
2408                     ; 511     status = (uint8_t)(ADC1->AWSRL & (uint8_t)((uint8_t)1 << Channel));
2410  0043 5f            	clrw	x
...
2423  0053               L567:
2424                     ; 515     status = (uint8_t)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (Channel - (uint8_t)8)));
...
2438  0063               L767:
2439                     ; 518   return ((FlagStatus)status);
2443  0063 85            	popw	x
2444  0064 81            	ret	
2599                     ; 527 FlagStatus ADC1_GetFlagStatus(ADC1_Flag_TypeDef Flag)
2599                     ; 528 {
...
2608                     ; 529   uint8_t flagstatus = 0;
2610                     ; 530   uint8_t temp = 0;
2612                     ; 533   assert_param(IS_ADC1_FLAG_OK(Flag));
...
2678                     ; 546       flagstatus = (uint8_t)(ADC1->AWSRL & (uint8_t)((uint8_t)1 << temp));
2680  0066 5f            	clrw	x
...
2693  0076               L1601:
2694                     ; 550       flagstatus = (uint8_t)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (temp - 8)));
...
2709  0088               L7501:
2710                     ; 555     flagstatus = (uint8_t)(ADC1->CSR & Flag);
2712  0088 c65400        	ld	a,21504
2713  008b 1402          	and	a,(OFST+1,sp)
2714  008d               L5501:
2715                     ; 557   return ((FlagStatus)flagstatus);
2719  008d 85            	popw	x
2720  008e 81            	ret	
2763                     ; 567 void ADC1_ClearFlag(ADC1_Flag_TypeDef Flag)
2763                     ; 568 {
...
2772                     ; 569   uint8_t temp = 0;
2774  0002 0f01          	clr	(OFST+0,sp)
2775                     ; 572   assert_param(IS_ADC1_FLAG_OK(Flag));
...
2839                     ; 585       ADC1->AWSRL &= (uint8_t)~(uint8_t)((uint8_t)1 << temp);
2841  0065 5f            	clrw	x
...
2856  0079               L5111:
2857                     ; 589       ADC1->AWSRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (temp - 8));
...
2874  008f               L3111:
2875                     ; 594     ADC1->CSR &= (uint8_t) (~Flag);
...
2885  0098 85            	popw	x
2886  0099 81            	ret	
2940                     ; 616 ITStatus ADC1_GetITStatus(ADC1_IT_TypeDef ITPendingBit)
2940                     ; 617 {
...
2949                     ; 618   ITStatus itstatus = RESET;
2951                     ; 619   uint8_t temp = 0;
2953                     ; 622   assert_param(IS_ADC1_ITPENDINGBIT_OK(ITPendingBit));
...
2990  0053               L605:
2991                     ; 624   if (((uint16_t)ITPendingBit & 0xF0) == 0x10)
...
2999                     ; 627     temp = (uint8_t)((uint16_t)ITPendingBit & 0x0F);
...
3008                     ; 630       itstatus = (ITStatus)(ADC1->AWSRL & (uint8_t)((uint8_t)1 << temp));
3010  0068 5f            	clrw	x
...
3023  0078               L1511:
3024                     ; 634       itstatus = (ITStatus)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (temp - 8)));
...
3039  008a               L7411:
3040                     ; 639     itstatus = (ITStatus)(ADC1->CSR & (uint8_t)ITPendingBit);
3042  008a c65400        	ld	a,21504
3043  008d 1403          	and	a,(OFST+2,sp)
3044  008f               L5511:
3045                     ; 641   return ((ITStatus)itstatus);
3049  008f 5b03          	addw	sp,#3
3050  0091 81            	ret	
3094                     ; 662 void ADC1_ClearITPendingBit(ADC1_IT_TypeDef ITPendingBit)
3094                     ; 663 {
...
3103                     ; 664   uint8_t temp = 0;
3105  0002 0f01          	clr	(OFST+0,sp)
3106                     ; 667   assert_param(IS_ADC1_ITPENDINGBIT_OK(ITPendingBit));
...
3142  0053               L035:
3143                     ; 669   if (((uint16_t)ITPendingBit & 0xF0) == 0x10)
...
3151                     ; 672     temp = (uint8_t)((uint16_t)ITPendingBit & 0x0F);
...
3160                     ; 675       ADC1->AWSRL &= (uint8_t)~(uint8_t)((uint8_t)1 << temp);
3162  0068 5f            	clrw	x
...
3177  007c               L1021:
3178                     ; 679       ADC1->AWSRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (temp - 8));
...
3195  0092               L7711:
3196                     ; 684     ADC1->CSR &= (uint8_t)((uint16_t)~(uint16_t)ITPendingBit);
