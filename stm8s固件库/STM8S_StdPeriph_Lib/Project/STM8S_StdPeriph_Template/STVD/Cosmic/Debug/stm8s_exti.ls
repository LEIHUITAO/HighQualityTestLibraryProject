  ...
  33                     ; 53 void EXTI_DeInit(void)
  33                     ; 54 {
  35                     .text:	section	.text,new
  36  0000               _EXTI_DeInit:
  40                     ; 55   EXTI->CR1 = EXTI_CR1_RESET_VALUE;
  42  0000 725f50a0      	clr	20640
  43                     ; 56   EXTI->CR2 = EXTI_CR2_RESET_VALUE;
  45  0004 725f50a1      	clr	20641
  46                     ; 57 }
  49  0008 81            	ret	
 175                     ; 70 void EXTI_SetExtIntSensitivity(EXTI_Port_TypeDef Port, EXTI_Sensitivity_TypeDef SensitivityValue)
 175                     ; 71 {
 176                     .text:	section	.text,new
 177  0000               _EXTI_SetExtIntSensitivity:
 179  0000 89            	pushw	x
 180       00000000      OFST:	set	0
 183                     ; 73   assert_param(IS_EXTI_PORT_OK(Port));
 185  0001 9e            	ld	a,xh
 186  0002 4d            	tnz	a
 ...
 200  0018 ae0049        	ldw	x,#73
 201  001b ad7c          	call	LC004
 202  001d               L41:
 203                     ; 74   assert_param(IS_EXTI_SENSITIVITY_OK(SensitivityValue));
 ...
 258  0061               L52:
 259                     ; 87   case EXTI_PORT_GPIOC:
 259                     ; 88     EXTI->CR1 &= (uint8_t)(~EXTI_CR1_PCIS);
 261  0061 c650a0        	ld	a,20640
 262  0064 a4cf          	and	a,#207
 263  0066 c750a0        	ld	20640,a
 264                     ; 89     EXTI->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 4);
 ...
 272  0070               L72:
 273                     ; 91   case EXTI_PORT_GPIOD:
 273                     ; 92     EXTI->CR1 &= (uint8_t)(~EXTI_CR1_PDIS);
 275  0070 c650a0        	ld	a,20640
 276  0073 a43f          	and	a,#63
 277  0075 c750a0        	ld	20640,a
 278                     ; 93     EXTI->CR1 |= (uint8_t)((uint8_t)(SensitivityValue) << 6);
 ...
 293  0087               L13:
 294                     ; 95   case EXTI_PORT_GPIOE:
 294                     ; 96     EXTI->CR2 &= (uint8_t)(~EXTI_CR2_PEIS);
 296  0087 c650a1        	ld	a,20641
 297  008a a4fc          	and	a,#252
 298  008c c750a1        	ld	20641,a
 299                     ; 97     EXTI->CR2 |= (uint8_t)(SensitivityValue);
 ...
 323  00a4 81            	ret	
 381                     ; 111 void EXTI_SetTLISensitivity(EXTI_TLISensitivity_TypeDef SensitivityValue)
 381                     ; 112 {
 382                     .text:	section	.text,new
 383  0000               _EXTI_SetTLISensitivity:
 385  0000 88            	push	a
 386       00000000      OFST:	set	0
 389                     ; 114   assert_param(IS_EXTI_TLISENSITIVITY_OK(SensitivityValue));
 391  0001 4d            	tnz	a
 392  0002 2712          	jreq	L63
 393  0004 a104          	cp	a,#4
 394  0006 270e          	jreq	L63
 395  0008 ae0072        	ldw	x,#114
 396  000b 89            	pushw	x
 397  000c 5f            	clrw	x
 398  000d 89            	pushw	x
 ...
 403  0016               L63:
 404                     ; 117   EXTI->CR2 &= (uint8_t)(~EXTI_CR2_TLIS);
 406  0016 721550a1      	bres	20641,#2
 407                     ; 118   EXTI->CR2 |= (uint8_t)(SensitivityValue);
 ...
 415  0022 84            	pop	a
 416  0023 81            	ret	
 461                     ; 126 EXTI_Sensitivity_TypeDef EXTI_GetExtIntSensitivity(EXTI_Port_TypeDef Port)
 461                     ; 127 {
 ...
 470                     ; 128   uint8_t value = 0;
 472  0002 0f01          	clr	(OFST+0,sp)
 473                     ; 131   assert_param(IS_EXTI_PORT_OK(Port));
 475  0004 4d            	tnz	a
 ...
 510  0039               L541:
 511                     ; 135   case EXTI_PORT_GPIOA:
 511                     ; 136     value = (uint8_t)(EXTI->CR1 & EXTI_CR1_PAIS);
 513  0039 c650a0        	ld	a,20640
 514                     ; 137     break;
 516  003c 201c          	jp	LC006
 517  003e               L741:
 518                     ; 138   case EXTI_PORT_GPIOB:
 518                     ; 139     value = (uint8_t)((uint8_t)(EXTI->CR1 & EXTI_CR1_PBIS) >> 2);
 ...
 527  0047               L151:
 528                     ; 141   case EXTI_PORT_GPIOC:
 528                     ; 142     value = (uint8_t)((uint8_t)(EXTI->CR1 & EXTI_CR1_PCIS) >> 4);
 530  0047 c650a0        	ld	a,20640
 531  004a 4e            	swap	a
 532                     ; 143     break;
 534  004b 200d          	jp	LC006
 535  004d               L351:
 536                     ; 144   case EXTI_PORT_GPIOD:
 536                     ; 145     value = (uint8_t)((uint8_t)(EXTI->CR1 & EXTI_CR1_PDIS) >> 6);
 ...
 546  0057               L551:
 547                     ; 147   case EXTI_PORT_GPIOE:
 547                     ; 148     value = (uint8_t)(EXTI->CR2 & EXTI_CR2_PEIS);
 ...
 555                     ; 150   default:
 555                     ; 151     break;
 557                     ; 154   return((EXTI_Sensitivity_TypeDef)value);
 561  005c 85            	popw	x
 562  005d 81            	ret	
 596                     ; 162 EXTI_TLISensitivity_TypeDef EXTI_GetTLISensitivity(void)
 596                     ; 163 {
 597                     .text:	section	.text,new
 598  0000               _EXTI_GetTLISensitivity:
 600  0000 88            	push	a
 601       00000001      OFST:	set	1
 604                     ; 164   uint8_t value = 0;
 606  0001 0f01          	clr	(OFST+0,sp)
 607                     ; 167   value = (uint8_t)(EXTI->CR2 & EXTI_CR2_TLIS);
 609  0003 c650a1        	ld	a,20641
 610  0006 a404          	and	a,#4
 611                     ; 169   return((EXTI_TLISensitivity_TypeDef)value);
