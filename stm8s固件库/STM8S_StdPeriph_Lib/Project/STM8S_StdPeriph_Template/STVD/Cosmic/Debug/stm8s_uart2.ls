  ...
  46                     ; 60   UART2->BRR2 = UART2_BRR2_RESET_VALUE;  /*  Set UART2_BRR2 to reset value 0x00 */
  48  0006 725f5243      	clr	21059
  49                     ; 61   UART2->BRR1 = UART2_BRR1_RESET_VALUE;  /*  Set UART2_BRR1 to reset value 0x00 */
  51  000a 725f5242      	clr	21058
  52                     ; 63   UART2->CR1 = UART2_CR1_RESET_VALUE; /*  Set UART2_CR1 to reset value 0x00  */
  54  000e 725f5244      	clr	21060
  55                     ; 64   UART2->CR2 = UART2_CR2_RESET_VALUE; /*  Set UART2_CR2 to reset value 0x00  */
  57  0012 725f5245      	clr	21061
  58                     ; 65   UART2->CR3 = UART2_CR3_RESET_VALUE; /*  Set UART2_CR3 to reset value 0x00  */
  60  0016 725f5246      	clr	21062
  61                     ; 66   UART2->CR4 = UART2_CR4_RESET_VALUE; /*  Set UART2_CR4 to reset value 0x00  */
  63  001a 725f5247      	clr	21063
  64                     ; 67   UART2->CR5 = UART2_CR5_RESET_VALUE; /*  Set UART2_CR5 to reset value 0x00  */
  66  001e 725f5248      	clr	21064
  67                     ; 68   UART2->CR6 = UART2_CR6_RESET_VALUE; /*  Set UART2_CR6 to reset value 0x00  */
 ...
 390                     ; 85 void UART2_Init(uint32_t BaudRate, UART2_WordLength_TypeDef WordLength, UART2_StopBits_TypeDef StopBits, UART2_Parity_TypeDef Parity, UART2_SyncMode_TypeDef SyncMode, UART2_Mode_TypeDef Mode)
 390                     ; 86 {
 391                     .text:	section	.text,new
 392  0000               _UART2_Init:
 394  0000 520e          	subw	sp,#14
 395       0000000e      OFST:	set	14
 398                     ; 87   uint8_t BRR2_1 = 0, BRR2_2 = 0;
 402                     ; 88   uint32_t BaudRate_Mantissa = 0, BaudRate_Mantissa100 = 0;
 ...
 414                     ; 91   assert_param(IS_UART2_BAUDRATE_OK(BaudRate));
 ...
 424  001f ae005b        	ldw	x,#91
 425  0022 cd01bd        	call	LC001
 426  0025               L41:
 427                     ; 92   assert_param(IS_UART2_WORDLENGTH_OK(WordLength));
 429  0025 7b15          	ld	a,(OFST+7,sp)
 430  0027 270a          	jreq	L42
 431  0029 a110          	cp	a,#16
 432  002b 2706          	jreq	L42
 433  002d ae005c        	ldw	x,#92
 434  0030 cd01bd        	call	LC001
 435  0033               L42:
 436                     ; 93   assert_param(IS_UART2_STOPBITS_OK(StopBits));
 ...
 446  0043 ae005d        	ldw	x,#93
 447  0046 cd01bd        	call	LC001
 448  0049               L43:
 449                     ; 94   assert_param(IS_UART2_PARITY_OK(Parity));
 ...
 457  0055 ae005e        	ldw	x,#94
 458  0058 cd01bd        	call	LC001
 459  005b               L44:
 460                     ; 95   assert_param(IS_UART2_MODE_OK((uint8_t)Mode));
 ...
 479  007d ae005f        	ldw	x,#95
 480  0080 cd01bd        	call	LC001
 481  0083               L45:
 482                     ; 96   assert_param(IS_UART2_SYNCMODE_OK((uint8_t)SyncMode));
 ...
 564                     ; 122   BaudRate_Mantissa100 = (((uint32_t)CLK_GetClockFreq() * 100) / (BaudRate << 4));
 ...
 586                     ; 126   BRR2_1 = (uint8_t)((uint8_t)(((BaudRate_Mantissa100 - (BaudRate_Mantissa * 100))
 586                     ; 127                                 << 4) / 100) & (uint8_t)0x0F); 
 ...
 616                     ; 128   BRR2_2 = (uint8_t)((BaudRate_Mantissa >> 4) & (uint8_t)0xF0);
 ...
 775                     ; 181 void UART2_Cmd(FunctionalState NewState)
 775                     ; 182 {
 776                     .text:	section	.text,new
 777  0000               _UART2_Cmd:
 781                     ; 183   if (NewState != DISABLE)
 783  0000 4d            	tnz	a
 784  0001 2705          	jreq	L532
 785                     ; 186     UART2->CR1 &= (uint8_t)(~UART2_CR1_UARTD);
 787  0003 721b5244      	bres	21060,#5
 790  0007 81            	ret	
 791  0008               L532:
 792                     ; 191     UART2->CR1 |= UART2_CR1_UARTD; 
 794  0008 721a5244      	bset	21060,#5
 795                     ; 193 }
 798  000c 81            	ret	
 927                     ; 210 void UART2_ITConfig(UART2_IT_TypeDef UART2_IT, FunctionalState NewState)
 927                     ; 211 {
 ...
 936                     ; 212   uint8_t uartreg = 0, itpos = 0x00;
 940                     ; 215   assert_param(IS_UART2_CONFIG_IT_OK(UART2_IT));
 ...
 957  0027 ae00d7        	ldw	x,#215
 958  002a cd00b7        	call	LC007
 959  002d               L401:
 960                     ; 216   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 962  002d 7b07          	ld	a,(OFST+5,sp)
 963  002f 2708          	jreq	L411
 964  0031 4a            	dec	a
 965  0032 2705          	jreq	L411
 966  0034 ae00d8        	ldw	x,#216
 967  0037 ad7e          	call	LC007
 968  0039               L411:
 969                     ; 219   uartreg = (uint8_t)((uint16_t)UART2_IT >> 0x08);
 971  0039 7b03          	ld	a,(OFST+1,sp)
 972  003b 6b01          	ld	(OFST-1,sp),a
 973                     ; 222   itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)UART2_IT & (uint8_t)0x0F));
...
1046  008d               L533:
1047                     ; 251     else if (uartreg == 0x02)
1049  008d a102          	cp	a,#2
1050  008f 260b          	jrne	L143
1051                     ; 253       UART2->CR2 &= (uint8_t)(~itpos);
...
1060  009c               L143:
1061                     ; 255     else if (uartreg == 0x03)
1063  009c a103          	cp	a,#3
1064  009e 260b          	jrne	L543
1065                     ; 257       UART2->CR4 &= (uint8_t)(~itpos);
...
1074  00ab               L543:
1075                     ; 261       UART2->CR6 &= (uint8_t)(~itpos);
...
1097  00c2 81            	ret	
1154                     ; 272 void UART2_IrDAConfig(UART2_IrDAMode_TypeDef UART2_IrDAMode)
1154                     ; 273 {
1155                     .text:	section	.text,new
1156  0000               _UART2_IrDAConfig:
1158  0000 88            	push	a
1159       00000000      OFST:	set	0
1162                     ; 274   assert_param(IS_UART2_IRDAMODE_OK(UART2_IrDAMode));
1164  0001 a101          	cp	a,#1
1165  0003 2711          	jreq	L231
1166  0005 4d            	tnz	a
1167  0006 270e          	jreq	L231
1168  0008 ae0112        	ldw	x,#274
...
1253  0015               L441:
1254                     ; 297   if (NewState != DISABLE)
1256  0015 7b01          	ld	a,(OFST+1,sp)
1257  0017 2706          	jreq	L124
1258                     ; 300     UART2->CR5 |= UART2_CR5_IREN;
1260  0019 72125248      	bset	21064,#1
1262  001d 2004          	jra	L324
1263  001f               L124:
1264                     ; 305     UART2->CR5 &= ((uint8_t)~UART2_CR5_IREN);
1266  001f 72135248      	bres	21064,#1
1267  0023               L324:
1268                     ; 307 }
1271  0023 84            	pop	a
1272  0024 81            	ret	
1332                     ; 316 void UART2_LINBreakDetectionConfig(UART2_LINBreakDetectionLength_TypeDef UART2_LINBreakDetectionLength)
1332                     ; 317 {
1333                     .text:	section	.text,new
1334  0000               _UART2_LINBreakDetectionConfig:
1336  0000 88            	push	a
1337       00000000      OFST:	set	0
1340                     ; 319   assert_param(IS_UART2_LINBREAKDETECTIONLENGTH_OK(UART2_LINBreakDetectionLength));
1342  0001 4d            	tnz	a
1343  0002 2711          	jreq	L651
1344  0004 4a            	dec	a
1345  0005 270e          	jreq	L651
1346  0007 ae013f        	ldw	x,#319
...
1354  0015               L651:
1355                     ; 321   if (UART2_LINBreakDetectionLength != UART2_LINBREAKDETECTIONLENGTH_10BITS)
1357  0015 7b01          	ld	a,(OFST+1,sp)
1358  0017 2706          	jreq	L354
1359                     ; 323     UART2->CR4 |= UART2_CR4_LBDL;
1361  0019 721a5247      	bset	21063,#5
1363  001d 2004          	jra	L554
1364  001f               L354:
1365                     ; 327     UART2->CR4 &= ((uint8_t)~UART2_CR4_LBDL);
1367  001f 721b5247      	bres	21063,#5
1368  0023               L554:
1369                     ; 329 }
1372  0023 84            	pop	a
1373  0024 81            	ret	
1495                     ; 341 void UART2_LINConfig(UART2_LinMode_TypeDef UART2_Mode, 
1495                     ; 342                      UART2_LinAutosync_TypeDef UART2_Autosync, 
1495                     ; 343                      UART2_LinDivUp_TypeDef UART2_DivUp)
1495                     ; 344 {
1496                     .text:	section	.text,new
1497  0000               _UART2_LINConfig:
1499  0000 89            	pushw	x
1500       00000000      OFST:	set	0
1503                     ; 346   assert_param(IS_UART2_SLAVE_OK(UART2_Mode));
...
1589  005f 81            	ret	
1624                     ; 384 void UART2_LINCmd(FunctionalState NewState)
1624                     ; 385 {
1625                     .text:	section	.text,new
1626  0000               _UART2_LINCmd:
1628  0000 88            	push	a
1629       00000000      OFST:	set	0
1632                     ; 386   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1634  0001 4d            	tnz	a
1635  0002 2711          	jreq	L222
1636  0004 4a            	dec	a
1637  0005 270e          	jreq	L222
1638  0007 ae0182        	ldw	x,#386
...
1900  0016               L062:
1901                     ; 456   UART2->CR1 &= ((uint8_t)~UART2_CR1_WAKE);
1903  0016 72175244      	bres	21060,#3
1904                     ; 457   UART2->CR1 |= (uint8_t)UART2_WakeUp;
...
1912  0022 84            	pop	a
1913  0023 81            	ret	
1950                     ; 466 void UART2_ReceiverWakeUpCmd(FunctionalState NewState)
1950                     ; 467 {
1951                     .text:	section	.text,new
1952  0000               _UART2_ReceiverWakeUpCmd:
1954  0000 88            	push	a
1955       00000000      OFST:	set	0
1958                     ; 468   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1960  0001 4d            	tnz	a
1961  0002 2711          	jreq	L272
1962  0004 4a            	dec	a
1963  0005 270e          	jreq	L272
1964  0007 ae01d4        	ldw	x,#468
...
2075                     ; 503   return (uint16_t)((((uint16_t)UART2->DR) | temp) & ((uint16_t)0x01FF));
...
2294  0023 84            	pop	a
2295  0024 81            	ret	
2327                     ; 566 void UART2_SetGuardTime(uint8_t UART2_GuardTime)
2327                     ; 567 {
2328                     .text:	section	.text,new
2329  0000               _UART2_SetGuardTime:
2333                     ; 569   UART2->GTR = UART2_GuardTime;
2335  0000 c7524a        	ld	21066,a
2336                     ; 570 }
2339  0003 81            	ret	
2371                     ; 594 void UART2_SetPrescaler(uint8_t UART2_Prescaler)
2371                     ; 595 {
2372                     .text:	section	.text,new
2373  0000               _UART2_SetPrescaler:
2377                     ; 597   UART2->PSCR = UART2_Prescaler;
2379  0000 c7524b        	ld	21067,a
2380                     ; 598 }
2383  0003 81            	ret	
2541                     ; 606 FlagStatus UART2_GetFlagStatus(UART2_Flag_TypeDef UART2_FLAG)
2541                     ; 607 {
...
2550                     ; 608   FlagStatus status = RESET;
2552  0002 0f01          	clr	(OFST+0,sp)
2553                     ; 611   assert_param(IS_UART2_FLAG_OK(UART2_FLAG));
...
2639  0081               L1511:
2640                     ; 650       status = RESET;
2645  0081 4f            	clr	a
2646  0082               L3311:
2647                     ; 668   return  status;
2651  0082 5b03          	addw	sp,#3
2652  0084 81            	ret	
2653  0085               L5411:
2654                     ; 655     if ((UART2->SR & (uint8_t)UART2_FLAG) != (uint8_t)0x00)
2656  0085 c65240        	ld	a,21056
2657  0088 1503          	bcp	a,(OFST+2,sp)
2658  008a 27f5          	jreq	L1511
2659                     ; 658       status = SET;
2661  008c 20ef          	jp	LC010
2662                     ; 663       status = RESET;
2698                     ; 699 void UART2_ClearFlag(UART2_Flag_TypeDef UART2_FLAG)
2698                     ; 700 {
2699                     .text:	section	.text,new
2700  0000               _UART2_ClearFlag:
2702  0000 89            	pushw	x
2703       00000000      OFST:	set	0
2706                     ; 701   assert_param(IS_UART2_CLEAR_FLAG_OK(UART2_FLAG));
...
2848                     ; 740   ITStatus pendingbitstatus = RESET;
2850                     ; 741   uint8_t itpos = 0;
2852                     ; 742   uint8_t itmask1 = 0;
2854                     ; 743   uint8_t itmask2 = 0;
2856                     ; 744   uint8_t enablestatus = 0;
2858                     ; 747   assert_param(IS_UART2_GET_IT_OK(UART2_IT));
...
2885  003a               L653:
2886                     ; 750   itpos = (uint8_t)((uint8_t)1 << (uint8_t)((uint8_t)UART2_IT & (uint8_t)0x0F));
...
2901                     ; 752   itmask1 = (uint8_t)((uint8_t)UART2_IT >> (uint8_t)4);
2903  004b 7b04          	ld	a,(OFST+2,sp)
2904  004d 4e            	swap	a
2905  004e a40f          	and	a,#15
2906  0050 6b02          	ld	(OFST+0,sp),a
2907                     ; 754   itmask2 = (uint8_t)((uint8_t)1 << itmask1);
2909  0052 5f            	clrw	x
...
2920                     ; 757   if (UART2_IT == UART2_IT_PE)
2922  005f 1e03          	ldw	x,(OFST+1,sp)
2923  0061 a30100        	cpw	x,#256
2924  0064 260c          	jrne	L7421
2925                     ; 760     enablestatus = (uint8_t)((uint8_t)UART2->CR1 & itmask2);
2927  0066 c65244        	ld	a,21060
2928  0069 1402          	and	a,(OFST+0,sp)
2929  006b 6b02          	ld	(OFST+0,sp),a
2930                     ; 763     if (((UART2->SR & itpos) != (uint8_t)0x00) && enablestatus)
2932  006d c65240        	ld	a,21056
2934                     ; 766       pendingbitstatus = SET;
2936  0070 2020          	jp	LC013
2937                     ; 771       pendingbitstatus = RESET;
2938  0072               L7421:
2939                     ; 774   else if (UART2_IT == UART2_IT_LBDF)
2941  0072 a30346        	cpw	x,#838
2942  0075 260c          	jrne	L7521
2943                     ; 777     enablestatus = (uint8_t)((uint8_t)UART2->CR4 & itmask2);
2945  0077 c65247        	ld	a,21063
2946  007a 1402          	and	a,(OFST+0,sp)
2947  007c 6b02          	ld	(OFST+0,sp),a
2948                     ; 779     if (((UART2->CR4 & itpos) != (uint8_t)0x00) && enablestatus)
2950  007e c65247        	ld	a,21063
2952                     ; 782       pendingbitstatus = SET;
2954  0081 200f          	jp	LC013
2955                     ; 787       pendingbitstatus = RESET;
2956  0083               L7521:
2957                     ; 790   else if (UART2_IT == UART2_IT_LHDF)
2959  0083 a30412        	cpw	x,#1042
2960  0086 2616          	jrne	L7621
2961                     ; 793     enablestatus = (uint8_t)((uint8_t)UART2->CR6 & itmask2);
2963  0088 c65249        	ld	a,21065
2964  008b 1402          	and	a,(OFST+0,sp)
2965  008d 6b02          	ld	(OFST+0,sp),a
2966                     ; 795     if (((UART2->CR6 & itpos) != (uint8_t)0x00) && enablestatus)
