  ...
  69                     ; 48 void IWDG_WriteAccessCmd(IWDG_WriteAccess_TypeDef IWDG_WriteAccess)
  69                     ; 49 {
  71                     .text:	section	.text,new
  72  0000               _IWDG_WriteAccessCmd:
  74  0000 88            	push	a
  75       00000000      OFST:	set	0
  78                     ; 51   assert_param(IS_IWDG_WRITEACCESS_MODE_OK(IWDG_WriteAccess));
  80  0001 a155          	cp	a,#85
  81  0003 2711          	jreq	L21
  82  0005 4d            	tnz	a
  83  0006 270e          	jreq	L21
  84  0008 ae0033        	ldw	x,#51
  85  000b 89            	pushw	x
  86  000c 5f            	clrw	x
  87  000d 89            	pushw	x
 ...
 100  001b 84            	pop	a
 101  001c 81            	ret	
 192                     ; 63 void IWDG_SetPrescaler(IWDG_Prescaler_TypeDef IWDG_Prescaler)
 192                     ; 64 {
 193                     .text:	section	.text,new
 194  0000               _IWDG_SetPrescaler:
 196  0000 88            	push	a
 197       00000000      OFST:	set	0
 200                     ; 66   assert_param(IS_IWDG_PRESCALER_OK(IWDG_Prescaler));
 202  0001 4d            	tnz	a
