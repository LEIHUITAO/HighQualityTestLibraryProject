  ...
  99                     ; 53 void GPIO_DeInit(GPIO_TypeDef* GPIOx)
  99                     ; 54 {
 101                     .text:	section	.text,new
 102  0000               _GPIO_DeInit:
 106                     ; 55   GPIOx->ODR = GPIO_ODR_RESET_VALUE; /* Reset Output Data Register */
 108  0000 7f            	clr	(x)
 109                     ; 56   GPIOx->DDR = GPIO_DDR_RESET_VALUE; /* Reset Data Direction Register */
 111  0001 6f02          	clr	(2,x)
 112                     ; 57   GPIOx->CR1 = GPIO_CR1_RESET_VALUE; /* Reset Control Register 1 */
 114  0003 6f03          	clr	(3,x)
 115                     ; 58   GPIOx->CR2 = GPIO_CR2_RESET_VALUE; /* Reset Control Register 2 */
 117  0005 6f04          	clr	(4,x)
 118                     ; 59 }
 121  0007 81            	ret	
 362                     ; 71 void GPIO_Init(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin, GPIO_Mode_TypeDef GPIO_Mode)
 362                     ; 72 {
 363                     .text:	section	.text,new
 364  0000               _GPIO_Init:
 366  0000 89            	pushw	x
 367       00000000      OFST:	set	0
 370                     ; 77   assert_param(IS_GPIO_MODE_OK(GPIO_Mode));
 ...
 503  009e 81            	ret	
 546                     ; 141 void GPIO_Write(GPIO_TypeDef* GPIOx, uint8_t PortVal)
 546                     ; 142 {
 547                     .text:	section	.text,new
 548  0000               _GPIO_Write:
 550  0000 89            	pushw	x
 551       00000000      OFST:	set	0
 554                     ; 143   GPIOx->ODR = PortVal;
 ...
 562  0006 85            	popw	x
 563  0007 81            	ret	
 610                     ; 154 void GPIO_WriteHigh(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 610                     ; 155 {
 611                     .text:	section	.text,new
 612  0000               _GPIO_WriteHigh:
 614  0000 89            	pushw	x
 615       00000000      OFST:	set	0
 618                     ; 156   GPIOx->ODR |= (uint8_t)PortPins;
 620  0001 f6            	ld	a,(x)
 ...
 626  0005 85            	popw	x
 627  0006 81            	ret	
 674                     ; 167 void GPIO_WriteLow(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 674                     ; 168 {
 675                     .text:	section	.text,new
 676  0000               _GPIO_WriteLow:
 678  0000 89            	pushw	x
 679       00000000      OFST:	set	0
 682                     ; 169   GPIOx->ODR &= (uint8_t)(~PortPins);
 ...
 691  0006 85            	popw	x
 692  0007 81            	ret	
 739                     ; 180 void GPIO_WriteReverse(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef PortPins)
 739                     ; 181 {
 740                     .text:	section	.text,new
 741  0000               _GPIO_WriteReverse:
 743  0000 89            	pushw	x
 744       00000000      OFST:	set	0
 747                     ; 182   GPIOx->ODR ^= (uint8_t)PortPins;
 749  0001 f6            	ld	a,(x)
 ...
 755  0005 85            	popw	x
 756  0006 81            	ret	
 794                     ; 191 uint8_t GPIO_ReadOutputData(GPIO_TypeDef* GPIOx)
 794                     ; 192 {
 795                     .text:	section	.text,new
 796  0000               _GPIO_ReadOutputData:
 800                     ; 193   return ((uint8_t)GPIOx->ODR);
 802  0000 f6            	ld	a,(x)
 805  0001 81            	ret	
 842                     ; 202 uint8_t GPIO_ReadInputData(GPIO_TypeDef* GPIOx)
 842                     ; 203 {
 843                     .text:	section	.text,new
 844  0000               _GPIO_ReadInputData:
 848                     ; 204   return ((uint8_t)GPIOx->IDR);
 ...
 929                     ; 215   return ((BitStatus)(GPIOx->IDR & (uint8_t)GPIO_Pin));
 931  0001 e601          	ld	a,(1,x)
 932  0003 1405          	and	a,(OFST+5,sp)
 935  0005 85            	popw	x
 936  0006 81            	ret	
1015                     ; 225 void GPIO_ExternalPullUpConfig(GPIO_TypeDef* GPIOx, GPIO_Pin_TypeDef GPIO_Pin, FunctionalState NewState)
1015                     ; 226 {
