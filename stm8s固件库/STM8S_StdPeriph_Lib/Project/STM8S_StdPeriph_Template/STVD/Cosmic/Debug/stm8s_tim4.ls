  ...
  33                     ; 49 void TIM4_DeInit(void)
  33                     ; 50 {
  35                     .text:	section	.text,new
  36  0000               _TIM4_DeInit:
  40                     ; 51   TIM4->CR1 = TIM4_CR1_RESET_VALUE;
  42  0000 725f5340      	clr	21312
  43                     ; 52   TIM4->IER = TIM4_IER_RESET_VALUE;
  45  0004 725f5341      	clr	21313
  46                     ; 53   TIM4->CNTR = TIM4_CNTR_RESET_VALUE;
  48  0008 725f5344      	clr	21316
  49                     ; 54   TIM4->PSCR = TIM4_PSCR_RESET_VALUE;
  51  000c 725f5345      	clr	21317
  52                     ; 55   TIM4->ARR = TIM4_ARR_RESET_VALUE;
  54  0010 35ff5346      	mov	21318,#255
  55                     ; 56   TIM4->SR1 = TIM4_SR1_RESET_VALUE;
 ...
 174                     ; 68   assert_param(IS_TIM4_PRESCALER_OK(TIM4_Prescaler));
 176  0001 9e            	ld	a,xh
 177  0002 4d            	tnz	a
 ...
 434  0037 81            	ret	
 470                     ; 131 void TIM4_UpdateDisableConfig(FunctionalState NewState)
 470                     ; 132 {
 471                     .text:	section	.text,new
 472  0000               _TIM4_UpdateDisableConfig:
 474  0000 88            	push	a
 475       00000000      OFST:	set	0
 478                     ; 134   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 480  0001 4d            	tnz	a
 481  0002 2711          	jreq	L06
 482  0004 4a            	dec	a
 483  0005 270e          	jreq	L06
 484  0007 ae0086        	ldw	x,#134
 485  000a 89            	pushw	x
 486  000b 5f            	clrw	x
 487  000c 89            	pushw	x
 ...
 492  0015               L06:
 493                     ; 137   if (NewState != DISABLE)
 495  0015 7b01          	ld	a,(OFST+1,sp)
 496  0017 2706          	jreq	L371
 497                     ; 139     TIM4->CR1 |= TIM4_CR1_UDIS;
 499  0019 72125340      	bset	21312,#1
 501  001d 2004          	jra	L571
 502  001f               L371:
 503                     ; 143     TIM4->CR1 &= (uint8_t)(~TIM4_CR1_UDIS);
 505  001f 72135340      	bres	21312,#1
 506  0023               L571:
 507                     ; 145 }
 510  0023 84            	pop	a
 511  0024 81            	ret	
 570                     ; 155 void TIM4_UpdateRequestConfig(TIM4_UpdateSource_TypeDef TIM4_UpdateSource)
 570                     ; 156 {
 571                     .text:	section	.text,new
 572  0000               _TIM4_UpdateRequestConfig:
 574  0000 88            	push	a
 575       00000000      OFST:	set	0
 578                     ; 158   assert_param(IS_TIM4_UPDATE_SOURCE_OK(TIM4_UpdateSource));
 580  0001 4d            	tnz	a
 581  0002 2711          	jreq	L27
 582  0004 4a            	dec	a
 583  0005 270e          	jreq	L27
 584  0007 ae009e        	ldw	x,#158
 585  000a 89            	pushw	x
 586  000b 5f            	clrw	x
 587  000c 89            	pushw	x
 ...
 691  0016               L401:
 692                     ; 185   if (TIM4_OPMode != TIM4_OPMODE_REPETITIVE)
 694  0016 7b01          	ld	a,(OFST+1,sp)
 695  0018 2706          	jreq	L752
 696                     ; 187     TIM4->CR1 |= TIM4_CR1_OPM;
 698  001a 72165340      	bset	21312,#3
 700  001e 2004          	jra	L162
 701  0020               L752:
 702                     ; 191     TIM4->CR1 &= (uint8_t)(~TIM4_CR1_OPM);
 704  0020 72175340      	bres	21312,#3
 705  0024               L162:
 706                     ; 193 }
 709  0024 84            	pop	a
 710  0025 81            	ret	
 779                     ; 215 void TIM4_PrescalerConfig(TIM4_Prescaler_TypeDef Prescaler, TIM4_PSCReloadMode_TypeDef TIM4_PSCReloadMode)
 779                     ; 216 {
 780                     .text:	section	.text,new
 781  0000               _TIM4_PrescalerConfig:
 783  0000 89            	pushw	x
 784       00000000      OFST:	set	0
 787                     ; 218   assert_param(IS_TIM4_PRESCALER_RELOAD_OK(TIM4_PSCReloadMode));
 789  0001 9f            	ld	a,xl
 790  0002 4d            	tnz	a
 ...
 795  0009 ae00da        	ldw	x,#218
 796  000c ad31          	call	LC002
 797  000e               L611:
 798                     ; 219   assert_param(IS_TIM4_PRESCALER_OK(Prescaler));
 ...
 816  002e ae00db        	ldw	x,#219
 817  0031 ad0c          	call	LC002
 818  0033 7b01          	ld	a,(OFST+1,sp)
 819  0035               L621:
 820                     ; 222   TIM4->PSCR = (uint8_t)Prescaler;
 822  0035 c75345        	ld	21317,a
 823                     ; 225   TIM4->EGR = (uint8_t)TIM4_PSCReloadMode;
 ...
 841  004a 81            	ret	
 877                     ; 234 void TIM4_ARRPreloadConfig(FunctionalState NewState)
 877                     ; 235 {
 878                     .text:	section	.text,new
 879  0000               _TIM4_ARRPreloadConfig:
 881  0000 88            	push	a
 882       00000000      OFST:	set	0
 885                     ; 237   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 887  0001 4d            	tnz	a
 888  0002 2711          	jreq	L041
 889  0004 4a            	dec	a
 890  0005 270e          	jreq	L041
 891  0007 ae00ed        	ldw	x,#237
 892  000a 89            	pushw	x
 893  000b 5f            	clrw	x
 894  000c 89            	pushw	x
 ...
 899  0015               L041:
 900                     ; 240   if (NewState != DISABLE)
 902  0015 7b01          	ld	a,(OFST+1,sp)
 903  0017 2706          	jreq	L333
 904                     ; 242     TIM4->CR1 |= TIM4_CR1_ARPE;
 906  0019 721e5340      	bset	21312,#7
 908  001d 2004          	jra	L533
 909  001f               L333:
 910                     ; 246     TIM4->CR1 &= (uint8_t)(~TIM4_CR1_ARPE);
 912  001f 721f5340      	bres	21312,#7
 913  0023               L533:
 914                     ; 248 }
 917  0023 84            	pop	a
 918  0024 81            	ret	
 968                     ; 257 void TIM4_GenerateEvent(TIM4_EventSource_TypeDef TIM4_EventSource)
 968                     ; 258 {
 969                     .text:	section	.text,new
 970  0000               _TIM4_GenerateEvent:
 972  0000 88            	push	a
 973       00000000      OFST:	set	0
 976                     ; 260   assert_param(IS_TIM4_EVENT_SOURCE_OK(TIM4_EventSource));
 978  0001 4a            	dec	a
 979  0002 270e          	jreq	L051
 980  0004 ae0104        	ldw	x,#260
 981  0007 89            	pushw	x
 982  0008 5f            	clrw	x
 983  0009 89            	pushw	x
 ...
 988  0012               L051:
 989                     ; 263   TIM4->EGR = (uint8_t)(TIM4_EventSource);
 991  0012 7b01          	ld	a,(OFST+1,sp)
 992  0014 c75343        	ld	21315,a
 993                     ; 264 }
 996  0017 84            	pop	a
 997  0018 81            	ret	
1029                     ; 272 void TIM4_SetCounter(uint8_t Counter)
1029                     ; 273 {
1030                     .text:	section	.text,new
1031  0000               _TIM4_SetCounter:
1035                     ; 275   TIM4->CNTR = (uint8_t)(Counter);
1037  0000 c75344        	ld	21316,a
1038                     ; 276 }
1041  0003 81            	ret	
1073                     ; 284 void TIM4_SetAutoreload(uint8_t Autoreload)
1073                     ; 285 {
1074                     .text:	section	.text,new
1075  0000               _TIM4_SetAutoreload:
1079                     ; 287   TIM4->ARR = (uint8_t)(Autoreload);
1081  0000 c75346        	ld	21318,a
1082                     ; 288 }
1085  0003 81            	ret	
1108                     ; 295 uint8_t TIM4_GetCounter(void)
1108                     ; 296 {
1109                     .text:	section	.text,new
1110  0000               _TIM4_GetCounter:
1114                     ; 298   return (uint8_t)(TIM4->CNTR);
1116  0000 c65344        	ld	a,21316
1119  0003 81            	ret	
1143                     ; 306 TIM4_Prescaler_TypeDef TIM4_GetPrescaler(void)
1143                     ; 307 {
1144                     .text:	section	.text,new
1145  0000               _TIM4_GetPrescaler:
1149                     ; 309   return (TIM4_Prescaler_TypeDef)(TIM4->PSCR);
1151  0000 c65345        	ld	a,21317
1154  0003 81            	ret	
1234                     ; 319 FlagStatus TIM4_GetFlagStatus(TIM4_FLAG_TypeDef TIM4_FLAG)
1234                     ; 320 {
...
1243                     ; 321   FlagStatus bitstatus = RESET;
1245  0002 0f01          	clr	(OFST+0,sp)
1246                     ; 324   assert_param(IS_TIM4_GET_FLAG_OK(TIM4_FLAG));
1248  0004 4a            	dec	a
1249  0005 270e          	jreq	L071
1250  0007 ae0144        	ldw	x,#324
...
1258  0015               L071:
1259                     ; 326   if ((TIM4->SR1 & (uint8_t)TIM4_FLAG)  != 0)
1261  0015 c65342        	ld	a,21314
1262  0018 1502          	bcp	a,(OFST+1,sp)
1263  001a 2704          	jreq	L374
1264                     ; 328     bitstatus = SET;
1266  001c a601          	ld	a,#1
1268  001e 2001          	jra	L574
1269  0020               L374:
1270                     ; 332     bitstatus = RESET;
1272  0020 4f            	clr	a
1273  0021               L574:
1274                     ; 334   return ((FlagStatus)bitstatus);
1278  0021 85            	popw	x
1279  0022 81            	ret	
1315                     ; 344 void TIM4_ClearFlag(TIM4_FLAG_TypeDef TIM4_FLAG)
1315                     ; 345 {
1316                     .text:	section	.text,new
1317  0000               _TIM4_ClearFlag:
1319  0000 88            	push	a
1320       00000000      OFST:	set	0
1323                     ; 347   assert_param(IS_TIM4_GET_FLAG_OK(TIM4_FLAG));
1325  0001 4a            	dec	a
1326  0002 270e          	jreq	L002
1327  0004 ae015b        	ldw	x,#347
...
1335  0012               L002:
1336                     ; 350   TIM4->SR1 = (uint8_t)(~TIM4_FLAG);
