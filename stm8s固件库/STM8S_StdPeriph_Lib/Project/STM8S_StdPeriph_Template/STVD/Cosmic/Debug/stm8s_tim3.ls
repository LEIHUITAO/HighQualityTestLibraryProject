  ...
  33                     ; 51 void TIM3_DeInit(void)
  33                     ; 52 {
  35                     .text:	section	.text,new
  36  0000               _TIM3_DeInit:
  40                     ; 53   TIM3->CR1 = (uint8_t)TIM3_CR1_RESET_VALUE;
  42  0000 725f5320      	clr	21280
  43                     ; 54   TIM3->IER = (uint8_t)TIM3_IER_RESET_VALUE;
  45  0004 725f5321      	clr	21281
  46                     ; 55   TIM3->SR2 = (uint8_t)TIM3_SR2_RESET_VALUE;
  48  0008 725f5323      	clr	21283
  49                     ; 58   TIM3->CCER1 = (uint8_t)TIM3_CCER1_RESET_VALUE;
  51  000c 725f5327      	clr	21287
  52                     ; 61   TIM3->CCER1 = (uint8_t)TIM3_CCER1_RESET_VALUE;
  54  0010 725f5327      	clr	21287
  55                     ; 62   TIM3->CCMR1 = (uint8_t)TIM3_CCMR1_RESET_VALUE;
  57  0014 725f5325      	clr	21285
  58                     ; 63   TIM3->CCMR2 = (uint8_t)TIM3_CCMR2_RESET_VALUE;
  60  0018 725f5326      	clr	21286
  61                     ; 64   TIM3->CNTRH = (uint8_t)TIM3_CNTRH_RESET_VALUE;
  63  001c 725f5328      	clr	21288
  64                     ; 65   TIM3->CNTRL = (uint8_t)TIM3_CNTRL_RESET_VALUE;
  66  0020 725f5329      	clr	21289
  67                     ; 66   TIM3->PSCR = (uint8_t)TIM3_PSCR_RESET_VALUE;
  69  0024 725f532a      	clr	21290
  70                     ; 67   TIM3->ARRH  = (uint8_t)TIM3_ARRH_RESET_VALUE;
  72  0028 35ff532b      	mov	21291,#255
  73                     ; 68   TIM3->ARRL  = (uint8_t)TIM3_ARRL_RESET_VALUE;
  75  002c 35ff532c      	mov	21292,#255
  76                     ; 69   TIM3->CCR1H = (uint8_t)TIM3_CCR1H_RESET_VALUE;
  78  0030 725f532d      	clr	21293
  79                     ; 70   TIM3->CCR1L = (uint8_t)TIM3_CCR1L_RESET_VALUE;
  81  0034 725f532e      	clr	21294
  82                     ; 71   TIM3->CCR2H = (uint8_t)TIM3_CCR2H_RESET_VALUE;
  84  0038 725f532f      	clr	21295
  85                     ; 72   TIM3->CCR2L = (uint8_t)TIM3_CCR2L_RESET_VALUE;
  87  003c 725f5330      	clr	21296
  88                     ; 73   TIM3->SR1 = (uint8_t)TIM3_SR1_RESET_VALUE;
  90  0040 725f5322      	clr	21282
  91                     ; 74 }
  94  0044 81            	ret	
 260                     ; 82 void TIM3_TimeBaseInit( TIM3_Prescaler_TypeDef TIM3_Prescaler,
 260                     ; 83                         uint16_t TIM3_Period)
 260                     ; 84 {
 261                     .text:	section	.text,new
 262  0000               _TIM3_TimeBaseInit:
 264  0000 88            	push	a
 265       00000000      OFST:	set	0
 268                     ; 86   TIM3->PSCR = (uint8_t)(TIM3_Prescaler);
 270  0001 c7532a        	ld	21290,a
 271                     ; 88   TIM3->ARRH = (uint8_t)(TIM3_Period >> 8);
 273  0004 7b04          	ld	a,(OFST+4,sp)
 274  0006 c7532b        	ld	21291,a
 275                     ; 89   TIM3->ARRL = (uint8_t)(TIM3_Period);
 277  0009 7b05          	ld	a,(OFST+5,sp)
 278  000b c7532c        	ld	21292,a
 279                     ; 90 }
 282  000e 84            	pop	a
 283  000f 81            	ret	
 439                     ; 100 void TIM3_OC1Init(TIM3_OCMode_TypeDef TIM3_OCMode,
 439                     ; 101                   TIM3_OutputState_TypeDef TIM3_OutputState,
 439                     ; 102                   uint16_t TIM3_Pulse,
 439                     ; 103                   TIM3_OCPolarity_TypeDef TIM3_OCPolarity)
 439                     ; 104 {
 ...
 448                     ; 106   assert_param(IS_TIM3_OC_MODE_OK(TIM3_OCMode));
 450  0002 9e            	ld	a,xh
 451  0003 4d            	tnz	a
 ...
 468  001f ae006a        	ldw	x,#106
 469  0022 ad4b          	call	LC001
 470  0024               L61:
 471                     ; 107   assert_param(IS_TIM3_OUTPUT_STATE_OK(TIM3_OutputState));
 473  0024 7b03          	ld	a,(OFST+2,sp)
 474  0026 2709          	jreq	L62
 475  0028 a111          	cp	a,#17
 476  002a 2705          	jreq	L62
 477  002c ae006b        	ldw	x,#107
 478  002f ad3e          	call	LC001
 479  0031               L62:
 480                     ; 108   assert_param(IS_TIM3_OC_POLARITY_OK(TIM3_OCPolarity));
 482  0031 7b08          	ld	a,(OFST+7,sp)
 483  0033 2709          	jreq	L63
 484  0035 a122          	cp	a,#34
 485  0037 2705          	jreq	L63
 486  0039 ae006c        	ldw	x,#108
 487  003c ad31          	call	LC001
 488  003e               L63:
 489                     ; 111   TIM3->CCER1 &= (uint8_t)(~( TIM3_CCER1_CC1E | TIM3_CCER1_CC1P));
 491  003e c65327        	ld	a,21287
 492  0041 a4fc          	and	a,#252
 493  0043 c75327        	ld	21287,a
 494                     ; 113   TIM3->CCER1 |= (uint8_t)((uint8_t)(TIM3_OutputState  & TIM3_CCER1_CC1E   ) | (uint8_t)(TIM3_OCPolarity   & TIM3_CCER1_CC1P   ));
 ...
 504                     ; 116   TIM3->CCMR1 = (uint8_t)((uint8_t)(TIM3->CCMR1 & (uint8_t)(~TIM3_CCMR_OCM)) | (uint8_t)TIM3_OCMode);
 506  0058 c65325        	ld	a,21285
 507  005b a48f          	and	a,#143
 508  005d 1a02          	or	a,(OFST+1,sp)
 509  005f c75325        	ld	21285,a
 510                     ; 119   TIM3->CCR1H = (uint8_t)(TIM3_Pulse >> 8);
 512  0062 7b06          	ld	a,(OFST+5,sp)
 513  0064 c7532d        	ld	21293,a
 514                     ; 120   TIM3->CCR1L = (uint8_t)(TIM3_Pulse);
 ...
 532  007a 81            	ret	
 594                     ; 131 void TIM3_OC2Init(TIM3_OCMode_TypeDef TIM3_OCMode,
 594                     ; 132                   TIM3_OutputState_TypeDef TIM3_OutputState,
 594                     ; 133                   uint16_t TIM3_Pulse,
 594                     ; 134                   TIM3_OCPolarity_TypeDef TIM3_OCPolarity)
 594                     ; 135 {
 ...
 603                     ; 137   assert_param(IS_TIM3_OC_MODE_OK(TIM3_OCMode));
 605  0002 9e            	ld	a,xh
 606  0003 4d            	tnz	a
 ...
 623  001f ae0089        	ldw	x,#137
 624  0022 ad4b          	call	LC002
 625  0024               L05:
 626                     ; 138   assert_param(IS_TIM3_OUTPUT_STATE_OK(TIM3_OutputState));
 628  0024 7b03          	ld	a,(OFST+2,sp)
 629  0026 2709          	jreq	L06
 630  0028 a111          	cp	a,#17
 631  002a 2705          	jreq	L06
 632  002c ae008a        	ldw	x,#138
 633  002f ad3e          	call	LC002
 634  0031               L06:
 635                     ; 139   assert_param(IS_TIM3_OC_POLARITY_OK(TIM3_OCPolarity));
 637  0031 7b08          	ld	a,(OFST+7,sp)
 638  0033 2709          	jreq	L07
 639  0035 a122          	cp	a,#34
 640  0037 2705          	jreq	L07
 641  0039 ae008b        	ldw	x,#139
 642  003c ad31          	call	LC002
 643  003e               L07:
 644                     ; 143   TIM3->CCER1 &= (uint8_t)(~( TIM3_CCER1_CC2E |  TIM3_CCER1_CC2P ));
 646  003e c65327        	ld	a,21287
 647  0041 a4cf          	and	a,#207
 648  0043 c75327        	ld	21287,a
 649                     ; 145   TIM3->CCER1 |= (uint8_t)((uint8_t)(TIM3_OutputState  & TIM3_CCER1_CC2E   ) | (uint8_t)(TIM3_OCPolarity   & TIM3_CCER1_CC2P ));
 ...
 659                     ; 149   TIM3->CCMR2 = (uint8_t)((uint8_t)(TIM3->CCMR2 & (uint8_t)(~TIM3_CCMR_OCM)) | (uint8_t)TIM3_OCMode);
 661  0058 c65326        	ld	a,21286
 662  005b a48f          	and	a,#143
 663  005d 1a02          	or	a,(OFST+1,sp)
 664  005f c75326        	ld	21286,a
 665                     ; 153   TIM3->CCR2H = (uint8_t)(TIM3_Pulse >> 8);
 667  0062 7b06          	ld	a,(OFST+5,sp)
 668  0064 c7532f        	ld	21295,a
 669                     ; 154   TIM3->CCR2L = (uint8_t)(TIM3_Pulse);
 ...
 687  007a 81            	ret	
 869                     ; 166 void TIM3_ICInit(TIM3_Channel_TypeDef TIM3_Channel,
 869                     ; 167                  TIM3_ICPolarity_TypeDef TIM3_ICPolarity,
 869                     ; 168                  TIM3_ICSelection_TypeDef TIM3_ICSelection,
 869                     ; 169                  TIM3_ICPSC_TypeDef TIM3_ICPrescaler,
 869                     ; 170                  uint8_t TIM3_ICFilter)
 869                     ; 171 {
 870                     .text:	section	.text,new
 871  0000               _TIM3_ICInit:
 873  0000 89            	pushw	x
 874       00000000      OFST:	set	0
 877                     ; 173   assert_param(IS_TIM3_CHANNEL_OK(TIM3_Channel));
 879  0001 9e            	ld	a,xh
 880  0002 4d            	tnz	a
 ...
 885  0009 ae00ad        	ldw	x,#173
 886  000c ad6d          	call	LC003
 887  000e               L201:
 888                     ; 174   assert_param(IS_TIM3_IC_POLARITY_OK(TIM3_ICPolarity));
 890  000e 7b02          	ld	a,(OFST+2,sp)
 891  0010 2709          	jreq	L211
 892  0012 a144          	cp	a,#68
 893  0014 2705          	jreq	L211
 894  0016 ae00ae        	ldw	x,#174
 895  0019 ad60          	call	LC003
 896  001b               L211:
 897                     ; 175   assert_param(IS_TIM3_IC_SELECTION_OK(TIM3_ICSelection));
 ...
 906  0029 ae00af        	ldw	x,#175
 907  002c ad4d          	call	LC003
 908  002e               L221:
 909                     ; 176   assert_param(IS_TIM3_IC_PRESCALER_OK(TIM3_ICPrescaler));
 ...
 919  003e ae00b0        	ldw	x,#176
 920  0041 ad38          	call	LC003
 921  0043               L231:
 922                     ; 177   assert_param(IS_TIM3_IC_FILTER_OK(TIM3_ICFilter));
 924  0043 7b07          	ld	a,(OFST+7,sp)
 925  0045 a110          	cp	a,#16
 926  0047 2505          	jrult	L041
 927  0049 ae00b1        	ldw	x,#177
 928  004c ad2d          	call	LC003
 929  004e               L041:
 930                     ; 179   if (TIM3_Channel != TIM3_CHANNEL_2)
 932  004e 7b01          	ld	a,(OFST+1,sp)
 933  0050 4a            	dec	a
 934  0051 2714          	jreq	L533
 935                     ; 182     TI1_Config((uint8_t)TIM3_ICPolarity,
 935                     ; 183                (uint8_t)TIM3_ICSelection,
 935                     ; 184                (uint8_t)TIM3_ICFilter);
 ...
 945  005f 84            	pop	a
 946                     ; 187     TIM3_SetIC1Prescaler(TIM3_ICPrescaler);
 948  0060 7b06          	ld	a,(OFST+6,sp)
 949  0062 cd0000        	call	_TIM3_SetIC1Prescaler
 952  0065 2012          	jra	L733
 953  0067               L533:
 954                     ; 192     TI2_Config((uint8_t)TIM3_ICPolarity,
 954                     ; 193                (uint8_t)TIM3_ICSelection,
 954                     ; 194                (uint8_t)TIM3_ICFilter);
 ...
 964  0073 84            	pop	a
 965                     ; 197     TIM3_SetIC2Prescaler(TIM3_ICPrescaler);
 ...
 985  0086 81            	ret	
1075                     ; 210 void TIM3_PWMIConfig(TIM3_Channel_TypeDef TIM3_Channel,
1075                     ; 211                      TIM3_ICPolarity_TypeDef TIM3_ICPolarity,
1075                     ; 212                      TIM3_ICSelection_TypeDef TIM3_ICSelection,
1075                     ; 213                      TIM3_ICPSC_TypeDef TIM3_ICPrescaler,
1075                     ; 214                      uint8_t TIM3_ICFilter)
1075                     ; 215 {
...
1084                     ; 216   uint8_t icpolarity = (uint8_t)TIM3_ICPOLARITY_RISING;
1086                     ; 217   uint8_t icselection = (uint8_t)TIM3_ICSELECTION_DIRECTTI;
1088                     ; 220   assert_param(IS_TIM3_PWMI_CHANNEL_OK(TIM3_Channel));
1090  0002 7b03          	ld	a,(OFST+1,sp)
1091  0004 2709          	jreq	L261
1092  0006 4a            	dec	a
1093  0007 2706          	jreq	L261
1094  0009 ae00dc        	ldw	x,#220
1095  000c cd00b3        	call	LC004
1096  000f               L261:
1097                     ; 221   assert_param(IS_TIM3_IC_POLARITY_OK(TIM3_ICPolarity));
1099  000f 7b04          	ld	a,(OFST+2,sp)
1100  0011 270a          	jreq	L271
1101  0013 a144          	cp	a,#68
1102  0015 2706          	jreq	L271
1103  0017 ae00dd        	ldw	x,#221
1104  001a cd00b3        	call	LC004
1105  001d               L271:
1106                     ; 222   assert_param(IS_TIM3_IC_SELECTION_OK(TIM3_ICSelection));
...
1115  002b ae00de        	ldw	x,#222
1116  002e cd00b3        	call	LC004
1117  0031               L202:
1118                     ; 223   assert_param(IS_TIM3_IC_PRESCALER_OK(TIM3_ICPrescaler));
...
1128  0041 ae00df        	ldw	x,#223
1129  0044 ad6d          	call	LC004
1130  0046               L212:
1131                     ; 226   if (TIM3_ICPolarity != TIM3_ICPOLARITY_FALLING)
1133  0046 7b04          	ld	a,(OFST+2,sp)
1134  0048 a144          	cp	a,#68
1135  004a 2706          	jreq	L104
1136                     ; 228     icpolarity = (uint8_t)TIM3_ICPOLARITY_FALLING;
1138  004c a644          	ld	a,#68
1139  004e 6b01          	ld	(OFST-1,sp),a
1141  0050 2002          	jra	L304
1142  0052               L104:
1143                     ; 232     icpolarity = (uint8_t)TIM3_ICPOLARITY_RISING;
1145  0052 0f01          	clr	(OFST-1,sp)
1146  0054               L304:
1147                     ; 236   if (TIM3_ICSelection == TIM3_ICSELECTION_DIRECTTI)
1149  0054 7b07          	ld	a,(OFST+5,sp)
1150  0056 4a            	dec	a
1151  0057 2604          	jrne	L504
1152                     ; 238     icselection = (uint8_t)TIM3_ICSELECTION_INDIRECTTI;
1154  0059 a602          	ld	a,#2
1156  005b 2002          	jra	L704
1157  005d               L504:
1158                     ; 242     icselection = (uint8_t)TIM3_ICSELECTION_DIRECTTI;
1160  005d a601          	ld	a,#1
1161  005f               L704:
1162  005f 6b02          	ld	(OFST+0,sp),a
1163                     ; 245   if (TIM3_Channel != TIM3_CHANNEL_2)
1165  0061 7b03          	ld	a,(OFST+1,sp)
1166  0063 4a            	dec	a
1167  0064 2726          	jreq	L114
1168                     ; 248     TI1_Config((uint8_t)TIM3_ICPolarity, (uint8_t)TIM3_ICSelection,
1168                     ; 249                (uint8_t)TIM3_ICFilter);
...
1178  0072 84            	pop	a
1179                     ; 252     TIM3_SetIC1Prescaler(TIM3_ICPrescaler);
1181  0073 7b08          	ld	a,(OFST+6,sp)
1182  0075 cd0000        	call	_TIM3_SetIC1Prescaler
1184                     ; 255     TI2_Config(icpolarity, icselection, TIM3_ICFilter);
...
1194  0084 84            	pop	a
1195                     ; 258     TIM3_SetIC2Prescaler(TIM3_ICPrescaler);
1197  0085 7b08          	ld	a,(OFST+6,sp)
1198  0087 cd0000        	call	_TIM3_SetIC2Prescaler
1201  008a 2024          	jra	L314
1202  008c               L114:
1203                     ; 263     TI2_Config((uint8_t)TIM3_ICPolarity, (uint8_t)TIM3_ICSelection,
1203                     ; 264                (uint8_t)TIM3_ICFilter);
...
1213  0098 84            	pop	a
1214                     ; 267     TIM3_SetIC2Prescaler(TIM3_ICPrescaler);
1216  0099 7b08          	ld	a,(OFST+6,sp)
1217  009b cd0000        	call	_TIM3_SetIC2Prescaler
1219                     ; 270     TI1_Config(icpolarity, icselection, TIM3_ICFilter);
...
1229  00aa 84            	pop	a
1230                     ; 273     TIM3_SetIC1Prescaler(TIM3_ICPrescaler);
...
1250  00be 81            	ret	
1305                     ; 283 void TIM3_Cmd(FunctionalState NewState)
1305                     ; 284 {
1306                     .text:	section	.text,new
1307  0000               _TIM3_Cmd:
1309  0000 88            	push	a
1310       00000000      OFST:	set	0
1313                     ; 286   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1315  0001 4d            	tnz	a
1316  0002 2711          	jreq	L442
1317  0004 4a            	dec	a
1318  0005 270e          	jreq	L442
1319  0007 ae011e        	ldw	x,#286
...
1480  003c 81            	ret	
1516                     ; 335 void TIM3_UpdateDisableConfig(FunctionalState NewState)
1516                     ; 336 {
1517                     .text:	section	.text,new
1518  0000               _TIM3_UpdateDisableConfig:
1520  0000 88            	push	a
1521       00000000      OFST:	set	0
1524                     ; 338   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1526  0001 4d            	tnz	a
1527  0002 2711          	jreq	L672
1528  0004 4a            	dec	a
1529  0005 270e          	jreq	L672
1530  0007 ae0152        	ldw	x,#338
...
1638  0015               L013:
1639                     ; 365   if (TIM3_UpdateSource != TIM3_UPDATESOURCE_GLOBAL)
1641  0015 7b01          	ld	a,(OFST+1,sp)
1642  0017 2706          	jreq	L755
1643                     ; 367     TIM3->CR1 |= TIM3_CR1_URS;
1645  0019 72145320      	bset	21280,#2
1647  001d 2004          	jra	L165
1648  001f               L755:
1649                     ; 371     TIM3->CR1 &= (uint8_t)(~TIM3_CR1_URS);
...
1755  0024 84            	pop	a
1756  0025 81            	ret	
1825                     ; 427 void TIM3_PrescalerConfig(TIM3_Prescaler_TypeDef Prescaler,
1825                     ; 428                           TIM3_PSCReloadMode_TypeDef TIM3_PSCReloadMode)
1825                     ; 429 {
1826                     .text:	section	.text,new
1827  0000               _TIM3_PrescalerConfig:
1829  0000 89            	pushw	x
1830       00000000      OFST:	set	0
1833                     ; 431   assert_param(IS_TIM3_PRESCALER_RELOAD_OK(TIM3_PSCReloadMode));
...
1841  0009 ae01af        	ldw	x,#431
1842  000c ad51          	call	LC006
1843  000e               L433:
1844                     ; 432   assert_param(IS_TIM3_PRESCALER_OK(Prescaler));
...
1878  004e ae01b0        	ldw	x,#432
1879  0051 ad0c          	call	LC006
1880  0053 7b01          	ld	a,(OFST+1,sp)
1881  0055               L443:
1882                     ; 435   TIM3->PSCR = (uint8_t)Prescaler;
1884  0055 c7532a        	ld	21290,a
1885                     ; 438   TIM3->EGR = (uint8_t)TIM3_PSCReloadMode;
...
1983  0017               L653:
1984                     ; 456   TIM3->CCMR1 =  (uint8_t)((uint8_t)(TIM3->CCMR1 & (uint8_t)(~TIM3_CCMR_OCM))  | (uint8_t)TIM3_ForcedAction);
...
2053  0017               L073:
2054                     ; 474   TIM3->CCMR2 =  (uint8_t)((uint8_t)(TIM3->CCMR2 & (uint8_t)(~TIM3_CCMR_OCM)) | (uint8_t)TIM3_ForcedAction);
...
2063  0021 84            	pop	a
2064  0022 81            	ret	
2101                     ; 483 void TIM3_ARRPreloadConfig(FunctionalState NewState)
2101                     ; 484 {
2102                     .text:	section	.text,new
2103  0000               _TIM3_ARRPreloadConfig:
2105  0000 88            	push	a
2106       00000000      OFST:	set	0
2109                     ; 486   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
2111  0001 4d            	tnz	a
2112  0002 2711          	jreq	L204
2113  0004 4a            	dec	a
2114  0005 270e          	jreq	L204
2115  0007 ae01e6        	ldw	x,#486
...
2279  0015               L624:
2280                     ; 533   if (NewState != DISABLE)
2282  0015 7b01          	ld	a,(OFST+1,sp)
2283  0017 2706          	jreq	L577
2284                     ; 535     TIM3->CCMR2 |= TIM3_CCMR_OCxPE;
2286  0019 72165326      	bset	21286,#3
2288  001d 2004          	jra	L777
2289  001f               L577:
2290                     ; 539     TIM3->CCMR2 &= (uint8_t)(~TIM3_CCMR_OCxPE);
2292  001f 72175326      	bres	21286,#3
2293  0023               L777:
2294                     ; 541 }
2297  0023 84            	pop	a
2298  0024 81            	ret	
2364                     ; 552 void TIM3_GenerateEvent(TIM3_EventSource_TypeDef TIM3_EventSource)
2364                     ; 553 {
2365                     .text:	section	.text,new
2366  0000               _TIM3_GenerateEvent:
2368  0000 88            	push	a
2369       00000000      OFST:	set	0
2372                     ; 555   assert_param(IS_TIM3_EVENT_SOURCE_OK(TIM3_EventSource));
2374  0001 4d            	tnz	a
2375  0002 260e          	jrne	L634
2376  0004 ae022b        	ldw	x,#555
...
2530  0016               L264:
2531                     ; 599   if (TIM3_OCPolarity != TIM3_OCPOLARITY_HIGH)
2533  0016 7b01          	ld	a,(OFST+1,sp)
2534  0018 2706          	jreq	L1701
2535                     ; 601     TIM3->CCER1 |= TIM3_CCER1_CC2P;
2537  001a 721a5327      	bset	21287,#5
2539  001e 2004          	jra	L3701
2540  0020               L1701:
2541                     ; 605     TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC2P);
2543  0020 721b5327      	bres	21287,#5
2544  0024               L3701:
2545                     ; 607 }
2548  0024 84            	pop	a
2549  0025 81            	ret	
2595                     ; 619 void TIM3_CCxCmd(TIM3_Channel_TypeDef TIM3_Channel, FunctionalState NewState)
2595                     ; 620 {
2596                     .text:	section	.text,new
2597  0000               _TIM3_CCxCmd:
2599  0000 89            	pushw	x
2600       00000000      OFST:	set	0
2603                     ; 622   assert_param(IS_TIM3_CHANNEL_OK(TIM3_Channel));
...
2670  0049 81            	ret	
2715                     ; 671 void TIM3_SelectOCxM(TIM3_Channel_TypeDef TIM3_Channel, TIM3_OCMode_TypeDef TIM3_OCMode)
2715                     ; 672 {
2716                     .text:	section	.text,new
2717  0000               _TIM3_SelectOCxM:
2719  0000 89            	pushw	x
2720       00000000      OFST:	set	0
2723                     ; 674   assert_param(IS_TIM3_CHANNEL_OK(TIM3_Channel));
...
2731  0009 ae02a2        	ldw	x,#674
2732  000c ad49          	call	LC008
2733  000e               L615:
2734                     ; 675   assert_param(IS_TIM3_OCM_OK(TIM3_OCMode));
...
2752  002e ae02a3        	ldw	x,#675
2753  0031 ad24          	call	LC008
2754  0033               L625:
2755                     ; 677   if (TIM3_Channel == TIM3_CHANNEL_1)
2757  0033 7b01          	ld	a,(OFST+1,sp)
2758  0035 2610          	jrne	L5511
2759                     ; 680     TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC1E);
2761  0037 72115327      	bres	21287,#0
2762                     ; 683     TIM3->CCMR1 = (uint8_t)((uint8_t)(TIM3->CCMR1 & (uint8_t)(~TIM3_CCMR_OCM)) | (uint8_t)TIM3_OCMode);
...
2770  0047               L5511:
2771                     ; 688     TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC2E);
2773  0047 72195327      	bres	21287,#4
2774                     ; 691     TIM3->CCMR2 = (uint8_t)((uint8_t)(TIM3->CCMR2 & (uint8_t)(~TIM3_CCMR_OCM)) | (uint8_t)TIM3_OCMode);
...
3053  001e               L055:
3054                     ; 763   TIM3->CCMR1 = (uint8_t)((uint8_t)(TIM3->CCMR1 & (uint8_t)(~TIM3_CCMR_ICxPSC)) | (uint8_t)TIM3_IC1Prescaler);
...
3063  0028 84            	pop	a
3064  0029 81            	ret	
3101                     ; 776 void TIM3_SetIC2Prescaler(TIM3_ICPSC_TypeDef TIM3_IC2Prescaler)
3101                     ; 777 {
3102                     .text:	section	.text,new
3103  0000               _TIM3_SetIC2Prescaler:
3105  0000 88            	push	a
3106       00000000      OFST:	set	0
3109                     ; 779   assert_param(IS_TIM3_IC_PRESCALER_OK(TIM3_IC2Prescaler));
3111  0001 4d            	tnz	a
...
3127  001e               L265:
3128                     ; 782   TIM3->CCMR2 = (uint8_t)((uint8_t)(TIM3->CCMR2 & (uint8_t)(~TIM3_CCMR_ICxPSC)) | (uint8_t)TIM3_IC2Prescaler);
...
3372  0017 81            	ret	
3396                     ; 844 TIM3_Prescaler_TypeDef TIM3_GetPrescaler(void)
3396                     ; 845 {
3397                     .text:	section	.text,new
3398  0000               _TIM3_GetPrescaler:
3402                     ; 847   return (TIM3_Prescaler_TypeDef)(TIM3->PSCR);
3404  0000 c6532a        	ld	a,21290
3407  0003 81            	ret	
3529                     ; 861 FlagStatus TIM3_GetFlagStatus(TIM3_FLAG_TypeDef TIM3_FLAG)
3529                     ; 862 {
...
3538                     ; 863   FlagStatus bitstatus = RESET;
3540                     ; 864   uint8_t tim3_flag_l = 0, tim3_flag_h = 0;
3544                     ; 867   assert_param(IS_TIM3_GET_FLAG_OK(TIM3_FLAG));
...
3656  001d               L416:
3657                     ; 900   TIM3->SR1 = (uint8_t)(~((uint8_t)(TIM3_FLAG)));
3659  001d 7b02          	ld	a,(OFST+2,sp)
3660  001f 43            	cpl	a
3661  0020 c75322        	ld	21282,a
3662                     ; 901   TIM3->SR2 = (uint8_t)(~((uint8_t)((uint16_t)TIM3_FLAG >> 8)));
...
3670  0029 85            	popw	x
3671  002a 81            	ret	
3732                     ; 913 ITStatus TIM3_GetITStatus(TIM3_IT_TypeDef TIM3_IT)
3732                     ; 914 {
...
3741                     ; 915   ITStatus bitstatus = RESET;
3743                     ; 916   uint8_t TIM3_itStatus = 0, TIM3_itEnable = 0;
3747  0002 7b02          	ld	a,(OFST+0,sp)
3748  0004 97            	ld	xl,a
3749                     ; 919   assert_param(IS_TIM3_GET_IT_OK(TIM3_IT));
...
3859  0016               L636:
3860                     ; 951   TIM3->SR1 = (uint8_t)(~TIM3_IT);
...
3868  001c 84            	pop	a
3869  001d 81            	ret	
3915                     ; 970 static void TI1_Config(uint8_t TIM3_ICPolarity,
3915                     ; 971                        uint8_t TIM3_ICSelection,
3915                     ; 972                        uint8_t TIM3_ICFilter)
3915                     ; 973 {
...
3924                     ; 975   TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC1E);
3926  0002 72115327      	bres	21287,#0
3927                     ; 978   TIM3->CCMR1 = (uint8_t)((uint8_t)(TIM3->CCMR1 & (uint8_t)(~( TIM3_CCMR_CCxS | TIM3_CCMR_ICxF))) | (uint8_t)(( (TIM3_ICSelection)) | ((uint8_t)( TIM3_ICFilter << 4))));
...
3940                     ; 981   if (TIM3_ICPolarity != TIM3_ICPOLARITY_RISING)
3942  001b 7b02          	ld	a,(OFST+1,sp)
3943  001d 2706          	jreq	L7451
3944                     ; 983     TIM3->CCER1 |= TIM3_CCER1_CC1P;
3946  001f 72125327      	bset	21287,#1
3948  0023 2004          	jra	L1551
3949  0025               L7451:
3950                     ; 987     TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC1P);
3952  0025 72135327      	bres	21287,#1
3953  0029               L1551:
3954                     ; 990   TIM3->CCER1 |= TIM3_CCER1_CC1E;
3956  0029 72105327      	bset	21287,#0
3957                     ; 991 }
3960  002d 5b03          	addw	sp,#3
3961  002f 81            	ret	
4007                     ; 1009 static void TI2_Config(uint8_t TIM3_ICPolarity,
4007                     ; 1010                        uint8_t TIM3_ICSelection,
4007                     ; 1011                        uint8_t TIM3_ICFilter)
4007                     ; 1012 {
...
4016                     ; 1014   TIM3->CCER1 &=  (uint8_t)(~TIM3_CCER1_CC2E);
4018  0002 72195327      	bres	21287,#4
4019                     ; 1017   TIM3->CCMR2 = (uint8_t)((uint8_t)(TIM3->CCMR2 & (uint8_t)(~( TIM3_CCMR_CCxS |
4019                     ; 1018                                                               TIM3_CCMR_ICxF    ))) | (uint8_t)(( (TIM3_ICSelection)) | 
4019                     ; 1019                                                                                                 ((uint8_t)( TIM3_ICFilter << 4))));
...
4032                     ; 1022   if (TIM3_ICPolarity != TIM3_ICPOLARITY_RISING)
4034  001b 7b02          	ld	a,(OFST+1,sp)
4035  001d 2706          	jreq	L3751
4036                     ; 1024     TIM3->CCER1 |= TIM3_CCER1_CC2P;
4038  001f 721a5327      	bset	21287,#5
4040  0023 2004          	jra	L5751
4041  0025               L3751:
4042                     ; 1028     TIM3->CCER1 &= (uint8_t)(~TIM3_CCER1_CC2P);
4044  0025 721b5327      	bres	21287,#5
4045  0029               L5751:
4046                     ; 1032   TIM3->CCER1 |= TIM3_CCER1_CC2E;
