  ...
  33                     ; 54 void BEEP_DeInit(void)
  33                     ; 55 {
  35                     .text:	section	.text,new
  36  0000               _BEEP_DeInit:
  40                     ; 56   BEEP->CSR = BEEP_CSR_RESET_VALUE;
  42  0000 351f50f3      	mov	20723,#31
  43                     ; 57 }
  46  0004 81            	ret	
 112                     ; 67 void BEEP_Init(BEEP_Frequency_TypeDef BEEP_Frequency)
 112                     ; 68 {
 113                     .text:	section	.text,new
 114  0000               _BEEP_Init:
 116  0000 88            	push	a
 117       00000000      OFST:	set	0
 120                     ; 70   assert_param(IS_BEEP_FREQUENCY_OK(BEEP_Frequency));
 122  0001 4d            	tnz	a
 ...
 336  002e               L23:
 337                     ; 126   lsifreqkhz = (uint16_t)(LSIFreqHz / 1000); /* Converts value in kHz */
 ...
 348                     ; 130   BEEP->CSR &= (uint8_t)(~BEEP_CSR_BEEPDIV); /* Clear bits */
 350  003f c650f3        	ld	a,20723
 351  0042 a4e0          	and	a,#224
 352  0044 c750f3        	ld	20723,a
 353                     ; 132   A = (uint16_t)(lsifreqkhz >> 3U); /* Division by 8, keep integer part only */
 355  0047 54            	srlw	x
 356  0048 54            	srlw	x
 357  0049 54            	srlw	x
 358  004a 1f05          	ldw	(OFST-1,sp),x
 359                     ; 134   if ((8U * A) >= ((lsifreqkhz - (8U * A)) * (1U + (2U * A))))
 361  004c 58            	sllw	x
 362  004d 58            	sllw	x
 363  004e 58            	sllw	x
 ...
 380                     ; 136     BEEP->CSR |= (uint8_t)(A - 2U);
 382  0070 a002          	sub	a,#2
 384  0072 2001          	jra	L131
 385  0074               L721:
 386                     ; 140     BEEP->CSR |= (uint8_t)(A - 1U);
 388  0074 4a            	dec	a
 389  0075               L131:
